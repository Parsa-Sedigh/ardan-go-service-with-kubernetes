...
func StopContainer(id string) error {
	...
	/* We have to run `docker remove -v` otherwise, you'll eat up all your disk space over time.*/
...
func extractIPPort(id string, port string) (hostIP string, hostPort string, err error) {
	/* Docker tools are written in go. We can give it a go template and extract exactly what we need. */
