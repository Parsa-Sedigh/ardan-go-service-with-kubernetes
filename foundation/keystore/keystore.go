...
// We have to maintain our privateKeys because we're generating JWTs.
...
// KeyLookup interface for use with the auth package. KeyStore keeps a map of our private keys.
