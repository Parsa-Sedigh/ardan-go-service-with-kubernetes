...
func init() {
	/* In our structured log, we would have a field named `service`. Maybe we want to filter the logs based on this field. You might do this when
	you have a pod that has multiple services(app containers) in it.*/
