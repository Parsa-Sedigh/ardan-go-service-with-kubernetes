...
/* This is the core app layer model for user group, it shouldn't have validation tags. Because we won't be receiving
any data against this model. */
type AppUser struct {
	ID           string   `json:"id"`
...
// we would get this model from client.
